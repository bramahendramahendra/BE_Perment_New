...
type (
	TemplateRepoInterface interface {
		...
		// GetTolakanPenyusunanKpiData mengambil seluruh data sub KPI beserta header dari DB
		...
		GetTolakanPenyusunanKpiData(idPengajuan string) (*model.TolakanExcelData, error)
